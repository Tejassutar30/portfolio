      ...
      <Container>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
          ...
          <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
            <p className="mb-5 font-mono text-xs font-medium uppercase tracking-wider text-[var(--color-accent)]">
              Current focus
            </p>

            <ul className="space-y-4">
              <li className="flex gap-3 text-sm leading-6 text-[var(--color-text-muted)]">
